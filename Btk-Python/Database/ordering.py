...
def getProducts():
    ...
    #cursor.execute("Select * From Products Order By name") #nameye göre alfabetik olarak bir sıralama işlemi yapar
    #cursor.execute("Select * From Products Order By price DESC") #priceye göre çoktan aza dogru sıralama yapar
