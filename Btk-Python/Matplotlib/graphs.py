...
# #plt.pie pasta grafigi şeklinde çizim yapar
...
# plt.pie(oylar, labels=partiler,colors=colors, shadow=True,explode=(0.025,0.025,0.025), autopct="%1.1f%%")
# #explode aralardaki mesafeyi, autopct ise sonucları % lik dilim olarak yazdırmayı ifade eder
# plt.show()
...
# plt.bar([0.25,1.25,2.25,3.25,4.25],[50,40,70,80,20],color = 'r',label="BMW",width=.25)
# plt.bar([0.75,1.75,2.75,3.75,4.75],[80,20,20,50,60],color = 'y',label="Audi",width=.25)
