...
class Window(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.radioTurkiye.setChecked(True) #form calıstırıldıgında varsayılan olarak seçili ayarlıyoruz
        self.ui.radioLise.setChecked(True) ##form calıstırıldıgında varsayılan olarak seçili ayarlıyoruz
